    ...
    RG.SVG.HBar = function (conf)
    {
        ...
        */
        ...
        this.propertyNameAliases = {
            ...
            //marginLeftAutosize:  'gutterLeftAutosize',
            //marginLeftAutofit:   'gutterLeftAutosize',
            //marginLeftAuto:      'gutterLeftAutosize',
            ...
            for (var i=0,sequentialIndex=0; i<this.data.length; ++i,++sequentialIndex) {
                ...
                if (typeof this.data[i] === 'number') {
                    ...
                    var outerSegment = (this.graphHeight - prop.vmarginTop - prop.vmarginBottom) / this.data.length,
                        ...
                        y            = prop.marginTop + prop.vmarginTop + prop.vmargin + (outerSegment * i);
                ...
                //
                    ...
                    for (var j=0; j<this.data[i].length; ++j,++sequentialIndex) {
                        ...
                        var width  = ma.abs((this.data[i][j] / (this.max - this.min)) * this.graphWidth),
                            ...
                            y      = prop.marginTop + prop.vmargin + prop.vmarginTop + (outerSegment * i) + (j * height) + (j * prop.vmarginGrouped),
                ...
                //
                    ...
                    for (var j=0; j<this.data[i].length; ++j,++sequentialIndex) {
                        ...
                        var outerHeight = (this.graphHeight - prop.vmarginTop - prop.vmarginBottom) / this.data.length,
                            ...
                            y           = prop.marginTop + prop.vmargin + prop.vmarginTop + (outerHeight * i);
        ...
        */
        this.parseColors = function () 
        {
            ...
            prop.backgroundGridColor = RG.SVG.parseColorLinear({object: this, color: prop.backgroundGridColor, direction: 'horizontal',start: prop.marginLeft,end: this.width - prop.marginRight});
            prop.highlightFill       = RG.SVG.parseColorLinear({object: this, color: prop.highlightFill, direction: 'horizontal',start: prop.marginLeft,end: this.width - prop.marginRight});
